...
namespace ChoSV.Services.Interfaces
{
    ...
    {
        Task<PagedResult<ProductListItemDTO>> SearchAndFilterProductsAsync(string? search, int? categoryId, decimal? minPrice, decimal? maxPrice, int page, int pageSize, string? userId = null, string? sortBy = "relevance");
